...
| `Download résumé` | `/resume` | Secondary button. Links to the résumé *page*, not a PDF — there are three role-tailored PDFs and the page is download-first (Appendix A#2). |
