...
{/* Internal note (PF-M3-06): the Typing Race repo URL and the QA Test Strategy doc URL
    still need product-owner sign-off. They render as plain, link-less text ("Source on
    GitHub" / "documented internally") until real URLs are supplied — never a guessed or
    placeholder link, and no bracketed marker in visible copy. */}
