...
links:
  ...
  repos:
    - { label: "Code", url: "https://github.com/JodPdo/typing-race" }
---
...
{/* Internal note (PF-M3-06): the QA Test Strategy doc URL still needs product-owner
    sign-off. It renders as plain, link-less text ("documented internally") until a real
    URL is supplied — never a guessed or placeholder link, and no bracketed marker in
    visible copy. (The repo URL was resolved and promoted to frontmatter `links.repos`.) */}
...
- **Code:** [github.com/JodPdo/typing-race](https://github.com/JodPdo/typing-race)
