...
- **Code:** [NEEDS-VERIFICATION: Tiger Kick repo URL — confirm with product owner before ship; on verification, link the repo and point readers at `.claude/agents`, `AGENT_INDEX.md`, `Tiger_Kick_Project_Docs`, and `tests/` as the process evidence]
